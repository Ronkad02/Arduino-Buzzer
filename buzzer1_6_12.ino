...
unsigned char melody11[] = {  //Leise rieselt der Schnee
...
short melody12[] = {  //I'm Blue
  932, 587, 784, 932, 1046, 698, 880, 932, 784, 932, 1174, 1244, 784, 1174, 1046, 932, 587, 784, 
  932, 1046, 698, 880, 932, 784, 932, 1174, 1244, 784, 1174, 1046, 932, 587, 784, 932, 1046, 698, 
  880, 932, 784, 932, 1174, 1244, 784, 1174, 1046, 932, 587, 784, 932, 880, 523, 698, 784, 932, 
  698, 784, 698, 784, 880, 932, 587, 784, 932, 1046, 698, 880, 932, 784, 932, 1174, 1244, 784, 
  1174, 1046, 932, 587, 784, 932, 1046, 698, 880, 932, 784, 932, 1174, 1244, 784, 1174, 1046, 932, 
  587, 784, 932, 1046, 698, 880, 932, 784, 932, 1174, 1244, 784, 1174, 1046, 932, 587, 784, 932, 
  880, 523, 698, 784
};
...
void ar1song(short melody[], unsigned char tempo) {
  unsigned char notes = sizeof(melody) / sizeof(melody[0]) / 2;
...
void ar2song(short melody[], short noteDurations[]) { 
  delay(100);
  for (short curentNote = 0; curentNote < sizeof(melody) / sizeof(melody[0]); curentNote++)
  {
...
void ar3song(unsigned char melody[], short noteDurations[], unsigned char pausDurations[]) { 
  for (short curentNote = 0; curentNote < sizeof(melody) / sizeof(melody[0]); curentNote++)
  {
    unsigned char pauseDuration = pausDurations[curentNote];
    butStatPlayPause = !digitalRead(butPlayPause);   //nur Pause
...
case 12:{
    ar2song(melody12, noteDurations12);
    break;
}
/*
case 13:{
